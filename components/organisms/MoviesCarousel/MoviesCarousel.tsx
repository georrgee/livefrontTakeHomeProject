...
//     overview: "A young pilot discovers a forgotten civilization in the clouds and must broker peace before war erupts.",
//     popularity: 87.3,
...
//     overview: "Two strangers keep bumping into each other over coffee; are they meant to be or is it just bad timing?",
//     popularity: 45.1,
...
//     overview: "A renovation crew awakens something malevolent in an old mansion; the walls remember everything.",
//     popularity: 62.0,
//     poster_path: null,
...
//   // const { movies, loading, error } = usePopularMovies(apiKey);
...
//           return (
//             <MovieCard movie={item} index={index} scrollX={scrollX} onPress={onSelect} isActive={isActive} />
//           );
//         }}
//       />
//     </View>
